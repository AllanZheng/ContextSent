...
int main(int argc, char* argv[]) {
  std::string trainFile = "test.scv", devFile = "test.scv", testFile = "test.scv", modelFile = "model.csv";
  std::string wordEmbFile = "wordEMb.csv", charEmbFile = "charEmb.csv", optionFile = "opt.csv";
  std::string outputFile = "res.csv";
  bool bTrain = false;
